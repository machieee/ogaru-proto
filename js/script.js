...
$(document).ready(function() {
  ...
  var dayColor = new Array("#F0A6B8", "#c6cdcb", "#c6cdcb", "#c6cdcb", "#c6cdcb", "#c6cdcb", "#A6C1E6");

  var day1Obj = getDay(1);
  var day2Obj = getDay(2);
  var day3Obj = getDay(3);
  ...
  $("#day1").html(convertTabDay(day1Obj));
  $("#day2").html(convertTabDay(day2Obj));
  $("#day3").html(convertTabDay(day3Obj));
  $("#day4").html(convertTabDay(day4Obj));
  $("#day5").html(convertTabDay(day5Obj));
  $("#day6").html(convertTabDay(day6Obj));

  $(".day1menutab").css("background-color", day1Obj[2]);
  $(".day2menutab").css("background-color", day2Obj[2]);
  $(".day3menutab").css("background-color", day3Obj[2]);
  ...
  //今日の日付を取得
  function getToday() {
    return (todayDate.getMonth()+1) + "月" + todayDate.getDate() + "日" + "(" + getDay(0)[1] + ")";
  }

  //今日を基準にＮ日後の日にち,曜日,曜日カラーを取得する
  function getDay(step) {
    var dayObj = new Array();
    var stepDate = new Date();
    stepDate.setDate(stepDate.getDate() + step);

    dayObj[0] = stepDate.getDate();
    dayObj[1] = dayList[stepDate.getDay()];
    dayObj[2] = dayColor[stepDate.getDay()];

    return dayObj;
  }

  //タブ表示用の日付文字列で返却する
  function convertTabDay(dayObj) {
